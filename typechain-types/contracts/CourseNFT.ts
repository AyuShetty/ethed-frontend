...
export interface CourseNFT extends BaseContract {
  ...
  mintWithENS: TypedContractMethod<
    [to: AddressLike, uri: string, ensName: string],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "CertificateMinted(address,uint256,string,string)": TypedContractEvent<
      CertificateMintedEvent.InputTuple,
      CertificateMintedEvent.OutputTuple,
      CertificateMintedEvent.OutputObject
    >;
