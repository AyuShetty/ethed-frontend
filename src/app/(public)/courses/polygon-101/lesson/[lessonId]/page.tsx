...
function renderTextContent(content: string) {
  ...
  while (i < lines.length) {
    ...
    // Sub headings (## )
      ...
      elements.push(
        <h2 key={i} className="text-2xl font-semibold text-cyan-300 mb-4 mt-6">
          {line.substring(3)}
        </h2>
      );
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center text-white">
        <div className="text-center">
          ...
          <Button asChild>
            <a href="/courses/polygon-101">Back to Course</a>
          </Button>
        </div>
      </div>
    );
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-950 border border-slate-700 rounded-xl p-6 shadow-2xl">
                  <pre className="text-base leading-relaxed overflow-x-auto">
                    <code className="font-mono text-green-300">{currentModule.code}</code>
                  </pre>
                </div>
              </div>
            )}
        ...
        <div className="flex justify-between items-center">
          {moduleId > 1 ? (
            ...
            >
              <a href={`/courses/polygon-101/lesson/${moduleId - 1}`}>
                <ArrowLeft className="mr-2 h-4 w-4" /> 
                Previous Lesson
              </a>
            </Button>
