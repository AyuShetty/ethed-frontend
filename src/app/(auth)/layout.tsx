...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12 bg-[radial-gradient(ellipse_120%_70%_at_50%_-20%,#0f4b4b20_0%,#031616_70%,#000000_100%)] text-cyan-100 overflow-hidden">
      ...
      <Link
        ...
        className={buttonVariants({
          variant: "ghost",
          className:
            "absolute left-6 top-6 flex items-center gap-2 bg-black/50 border border-cyan-600/40 text-cyan-200 hover:text-emerald-300 shadow-lg shadow-emerald-400/10 backdrop-blur-md px-5 py-2 rounded-full font-semibold transition-all hover:scale-105",
        })}
      >
      ...
      {/* Auth Card */}
      <div className="relative z-10 w-full max-w-sm flex flex-col gap-8 rounded-2xl border border-cyan-600/40 bg-slate-950/90 shadow-xl shadow-emerald-400/10 backdrop-blur-lg px-8 py-10">
        {children}
      </div>
